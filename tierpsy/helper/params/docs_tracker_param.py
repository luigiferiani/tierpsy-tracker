...
dflt_param_list = [
    ...
    ('MWP_whichsideup',
        'upright',
        '''
        If using a Multi Well Plate: was it placed under the microscope upright or upside_down?
        ''')
    ]
...
valid_options = {
    ...
    'MWP_total_n_wells':[-1, 12, 24, 48, 96], # caveat: whether the analysis will work or not depends on the code in tierpsy.analysis.compress.FOVMultiWellSplitter 
    'MWP_whichsideup':['upright','upside_down'],
}
